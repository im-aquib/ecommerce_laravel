  ...
  <body class="goto-here">
    	...
    	<div class="container">
    		<div class="row no-gutters d-flex align-items-start align-items-center px-md-0">
                ...
                <a href="tel:123456789"><span class="text">123456789</span></a> 
					    </div>
					    <div class="col-md pr-4 d-flex topper align-items-center">
					    	<div class="icon mr-2 d-flex justify-content-center align-items-center"><span class="icon-paper-plane"></span></div>
              <a href="mailto:vgfoods@email.com"><span class="text">VegeMart@email.com</span></a>  
					    </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="/">Vege Mart</a>
        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">Vege Mart</h2>
            ...
            <div class="ftco-footer-widget mb-5">
            	...
            	<div class="block-23 mb-3">
                  ...
                  <li><span class="icon icon-map-marker"></span><span class="text">203 Fake St. Mountain View, San Francisco, California, USA</span></li>
	                <li><a href="tel:123456789"><span class="icon icon-phone"></span><span class="text">+123456789</span></a></li>
	                <li><a href="mailto:VegeMart@email.com"><span class="icon icon-envelope"></span><span class="text">VegeMart@email.com</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
